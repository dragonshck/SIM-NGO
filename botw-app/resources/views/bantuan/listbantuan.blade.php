      ...
      <table class="table table-sm fs--1 mb-0 overflow-hidden">
        <thead class="bg-200 text-900">
          <tr>
            ...
            <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">Kelompok Umur</th>
        ...
        <tbody class="list" id="table-purchase-body">
          ...
          <tr class="btn-reveal-trigger">
              ...
              <th class="align-middle white-space-nowrap name">{{ $item -> helperku -> nama_ku }}</th>
              ...
              <td class="align-middle white-space-nowrap text-end">
                <div class="dropstart font-sans-serif position-static d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown5">
                    <a class="dropdown-item" href="/show-penerimaan-bantuan/{{ $item -> id }}">View</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="/delete-penerimaan-bantuan/{{ $item -> id }}">Delete</a>
                  </div>
                </div>
              </td>
          </tr>
