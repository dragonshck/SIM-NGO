      ...
      <table class="table table-sm fs--1 mb-0 overflow-hidden">
        <thead class="bg-200 text-900">
          <tr>
            ...
            <th class="sort pe-1 align-middle white-space-nowrap" >Kelompok Umur</th>
        ...
        <tbody class="list" id="table-purchase-body">
          ...
          <tr class="btn-reveal-trigger">
              <th class="align-middle white-space-nowrap">{{ $item -> kelompokumurz -> ku_description }}</th>
              <td class="align-middle white-space-nowrap ">{{ $item -> nama_bantuan }}</td>
              <td class="align-middle white-space-nowrap ">{{ $item -> keterangan }}</td>
              <td class="align-middle white-space-nowrap">@currency($item -> amount_bantuan)</td>
              <td class="align-middle white-space-nowrap text-end ">
                @if($item-> status_trxbantuan == 1)
              ...
              <td class="align-middle white-space-nowrap text-end">
                <div class="dropstart font-sans-serif position-static d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown5">
                    <a class="dropdown-item" href="{{ url('/ubah-status-bantuan/' . $item ->id)  }}">Completed</a>
                    <a class="dropdown-item" href="{{ url('/ubah-status-bantuan/' . $item ->id)  }}">Process</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('bantuan.show', $item -> id) }}">View</a>
                  </div>
                </div>
              </td>
          </tr>
