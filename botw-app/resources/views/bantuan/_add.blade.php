    ...
    <div class="card-body">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
              <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Transaksi Pengeluaran Rewards</h5>
            </div>
          </div>
        <form action="/tambah-penerimaan-bantuan" method="POST" enctype="multipart/form-data">
          @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="basic-form-gender" aria-label="Default select example" name="kelompokumur_id">
                <option selected="selected">Pilih KU yg Dapat Rewards</option>
                @foreach ($collection_ank as $itemanak)
                  <option value="{{ $itemanak -> id }}">{{ $itemanak -> nama_ku }}</option>
                @endforeach
              </select>
            </div>
            <div class="mb-3">
