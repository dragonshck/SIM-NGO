...
<div class="card mb-3">
    <img class="card-img-top" src="{{ asset('posterevent/' . $event -> gambar_event) }}" alt="">
    <div class="card-body">
        ...
        <div class="col">
          <div class="d-flex">
            ...
            <div class="flex-1 fs--1">
              <h5 class="fs-0">{{ $event -> summary }}</h5>
  ...
  <div class="row g-0">
    <div class="col-lg-8 pe-lg-2">
      <div class="card mb-3 mb-lg-0">
        <div class="card-body">
          <h5 class="fs-0 mb-3">Detail Kegiatan</h5>
    ...
    <div class="col-lg-4 ps-lg-2">
      <div class="sticky-sidebar">
        <div class="card mb-3 fs--1">
          <div class="card-body">
            <h6>Date And Time</h6>
            <p class="mb-1">{{ $startdate }}, {{ $starthour }} – {{ $enddate }}, {{ $endhour }}</p>
