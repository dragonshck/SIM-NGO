...
<div class="card mb-3">
    <div class="card-body">
      <div class="row flex-between-center">
        <div class="col-md">
          <h5 class="mb-2 mb-md-0">Edit Kegiatan</h5>
        </div>
        <div class="col-auto">
        ...
        <div class="card-body bg-light">
            ...
            <div class="row gx-2">
              <div class="col-12 mb-3">
                ...
                <input class="form-control" id="event-name" type="text" placeholder="Event Title" name="judul_kegiatan" value="{{ $getId -> judul_kegiatan}}">
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="start-date">Tanggal Mulai</label>
                <input class="form-control datetimepicker flatpickr-input" value="{{ $getId -> tgl_mulai }}" id="start-date" name="tgl_mulai" type="text" placeholder="d/m/y" data-options="{&quot;dateFormat&quot;:&quot;d-m-Y&quot;,&quot;disableMobile&quot;:true}" readonly="readonly">
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="start-time">Waktu Mulai</label>
                <input class="form-control datetimepicker flatpickr-input" value="{{ $getId -> jam_mulai }}" id="start-time" name="jam_mulai" type="text" placeholder="H:i" data-options="{&quot;enableTime&quot;:true,&quot;noCalendar&quot;:true,&quot;dateFormat&quot;:&quot;H:i&quot;,&quot;disableMobile&quot;:true}" readonly="readonly">
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="end-date">Tanggal Selesai</label>
                <input class="form-control datetimepicker flatpickr-input" value="{{ $getId -> tgl_selesai }}" id="end-date" name="tgl_selesai" type="text" placeholder="d/m/y" data-options="{&quot;dateFormat&quot;:&quot;d-m-Y&quot;,&quot;disableMobile&quot;:true}" readonly="readonly">
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="end-time">Waktu Selesai</label>
                <input class="form-control datetimepicker flatpickr-input" value="{{ $getId -> jam_selesai }}" id="end-time" name="jam_selesai" type="text" placeholder="H:i" data-options="{&quot;enableTime&quot;:true,&quot;noCalendar&quot;:true,&quot;dateFormat&quot;:&quot;H:i&quot;,&quot;disableMobile&quot;:true}" readonly="readonly">
              </div>
              ...
              <div class="col-sm-12 mb-3">
                <label class="form-label" for="event-venue">Tempat Pelaksanaan</label>
                <input class="form-control" id="event-venue" type="text" placeholder="Venue" name="tempat_pelaksanaan" value="{{ $getId -> tempat_pelaksanaan }}">
              </div>
              <div class="col-12">
