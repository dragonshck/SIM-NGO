                        ...
                        <div class="dropdown font-sans-serif position-static">
                            ...
                            <div class="dropdown-menu dropdown-menu-end border py-0">
                              <div class="bg-white py-2">
                                <a class="dropdown-item text-warning" href="{{ url('/ubah-status-lp/' . $syllabus -> id)  }}">Pending</a>
                                <a class="dropdown-item text-success" href="{{ url('/ubah-status-lp/' . $syllabus -> id)  }}">Approve</a></div>
