...
@section('updatepenerimaansponsor')
    <div class="card">
        <div class="card-body">
            <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                  <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Update Data Penerimaan Hadiah Sponsor</h5>
                </div>
              </div>
              <form action="/edit-penerimaan-sponsor/{{ $collection -> id }}" method="POST" enctype="multipart/form-data" class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone">
                @csrf
                  <div class="mb-3">
                    <label class="form-label" for="basic-form-name">Nama Transaksi</label>
                    <input class="form-control" id="basic-form-name" type="text" name="namatransaksi" value="{{ $collection -> namatransaksi }}"/>
                  </div>
                  <div class="input-group mb-3">
                    <span class="input-group-text">Rp</span><span class="input-group-text">Rupiah</span>
                    <input class="form-control" type="text" aria-label="Rupiah amount (with dot and two decimal places)" name="total_harga" value="{{ $collection -> total_harga }}"/>
                  </div>
                  <div class="mb-3">
                  ...
                  {{-- <div class="mb-3">
                    ...
                    <div class="fallback">
                      <input name="file" type="file" multiple="multiple" name="images[]" accept="image/*" />
                    </div>
                    ...
                    <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column">
                      <div class="d-flex media mb-3 pb-3 border-bottom btn-reveal-trigger">
                        <img class="dz-image" src="{{ asset('falcon-style/public/assets/img/generic/image-file-2.png')}}" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="basic-form-textarea" rows="3" placeholder="{{ $collection -> barang_dibeli}}" name="barang_dibeli"></textarea>
                  </div>
