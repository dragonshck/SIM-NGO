            ...
            <td class="align-middle text-nowrap">
              <div class="d-flex align-items-center">
                <div class="avatar avatar-xl">
                  <img class="rounded-circle" src="{{ asset('fotosponsor/'.$item -> fotoprofil)  }}" alt="" />
                </div>
                <div class="ms-2">{{ $item -> nama_sponsor }}</div>
              </div>
            </td>
            <td class="align-middle text-nowrap">{{ $item -> origincountry }}</td>
            <td class="w-auto">
              <div class="btn-group btn-group hover-actions end-0 me-4">
                <a class="btn btn-light pe-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="/daftar-datasponsor/{{ $item -> id }}"><span class="fas fa-edit"></span></a>
                <a class="btn btn-light ps-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" href="/delete-datasponsor/{{ $item -> id }}"><span class="fas fa-trash-alt"></span></a>
              </div>
            </td>
