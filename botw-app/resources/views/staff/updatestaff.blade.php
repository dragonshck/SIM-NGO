      ...
      <div class="card mb-3">
        ...
        <div class="card-body bg-light">
            ...
            <div class="col-lg-12">
              ...
              <input class="form-control" id="last-name" type="text" name="email" value="{{ $staff -> user -> email}}">
            </div>
            <div class="col-lg-12">
              <label class="form-label" for="email1">Password</label>
              <input class="form-control" id="email1" type="text" name="password" value="{{ $staff -> user -> password}}">
            </div>
            <div class="col-lg-12">
              <label class="form-label" for="email2">Phone</label>
              <input class="form-control" id="email2" type="text" name="phone" value="{{ $staff -> phone}}">
            </div>
            <div class="col-lg-12">
              <label class="form-label" for="datepicker">Date of Birth</label>
              <input class="form-control datetimepicker" id="datepicker" type="text" placeholder="d/m/y" data-options='{"disableMobile":true}' name="dateofbirth" value="{{ $staff -> dateofbirth}}"/>
            </div>
            <div class="col-lg-12">
              <label class="form-label" for="email3">Current Address</label>
              <input class="form-control" id="email3" type="text" name="current_addr" value="{{ $staff -> current_addr}}">
            </div>
            <div class="col-lg-12">
              <label class="form-label" for="email3">Permanent Address</label>
              <input class="form-control" id="email3" type="text" name="perm_addr" value="{{ $staff -> perm_addr}}">
            </div>
            <div class="col-lg-12">
              ...
              <select class="form-select" aria-label="Default select example" name="jabatan_staff_id" id="jabatan_staff_id">
                ...
                @foreach($jabatan_index as $index)
                <option value="{{ $index -> id }}">{{ $index -> nama_jabatan}}</option>
                @endforeach
              </select>
            </div>
            ...
            {{-- <div class="col-lg-12" id="kelompok_umur_id">
              ...
              <select class="form-select" aria-label="Default select example" name="kelompok_umur_id" >
                <option selected value="{{ $staff -> kelompokumur -> id}}">{{ $staff -> kelompokumur -> ku_description}}</option>
