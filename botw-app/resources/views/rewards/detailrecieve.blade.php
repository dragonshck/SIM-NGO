    ...
    <div class="card mb-3 mb-lg-0">
      ...
      <div class="card-body overflow-hidden">
        <div class="row mx-n1">
            ...
            <div class="col-4 p-1">
              <a class="post1" href="{{ asset('rewardsgift_images/'.$item -> image)}}" data-gallery="gallery-1">
              <img class="img-fluid rounded" src="{{ asset('rewardsgift_images/'.$item -> image)}}" alt="..."></a>
            </div>
            @endforeach
        </div>
      </div>
