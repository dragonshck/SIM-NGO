<link href="{{ asset('falcon-style/public/vendors/dropzone/dropzone.min.css" rel="stylesheet') }}" />
<script src="{{ asset('falcon-style/public/vendors/dropzone/dropzone.min.js') }}"></script>
@extends('main')
@section('updaterewards')
<div class="card-body">
