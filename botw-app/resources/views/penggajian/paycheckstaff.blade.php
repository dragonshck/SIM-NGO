            ...
            <table class="table table-hover table-striped overflow-hidden">
              ...
              <tbody>
                ...
                <tr class="align-middle">
                  <td class="text-nowrap">
                    <div class="d-flex align-items-center">
                      <div class="avatar avatar-xl">
                          <img class="rounded-circle" src="{{ asset('images/profile/' . $item->staff->user->profile_picture) }}" alt="" />
                      </div>
                  ...
                  <td class="text-end">
                    <a class="btn btn-outline-success btn-sm" type="button" href="{{ route('penggajian.show', $item -> id) }}">Detail
                    </a>
                  </td>
                </tr>
                @endforeach
